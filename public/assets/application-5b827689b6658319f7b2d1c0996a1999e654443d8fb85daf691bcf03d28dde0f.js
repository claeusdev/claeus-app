  ...
  jQuery(function() {
    ...
    return $("#product_category_id").change(function() {
      ...
      if (options) {
        ...
        return $('#product_children_id').parent().show();
      } else {
        $('#product_children_id').empty();
        return $('#product_children_id').parent().hide();
      }
    });
  });
...
(function() {
  ...
  Notifications = (function() {
    function Notifications() {
      ...
      this.handleRead = bind(this.handleRead, this);
    ...
    Notifications.prototype.setup = function() {
      $("[data-behavior='read-notifications']").on("click", this.handleRead);
      return $.ajax({
    ...
    Notifications.prototype.handleRead = function(e) {
      return $.ajax({
    ...
    Notifications.prototype.handleSuccess = function(data) {
      ...
      items = $.map(data, function(notification) {
        return "<a class='menuNav-item'>" + notification.actor.username + " " + notification.action + " " + notification.notifiable.type + " </a>";
      });
      ...
      if (items.length > 0) {
        ...
        return $("[data-behavior='notification-items']").html(none);
      }
    };
